...
// Vapi assistant configuration for Russian voice bot
export const assistantConfig: CreateAssistantDTO | Record<string, unknown> = {
		...
		tools: [
			{
				...
				description: 'Get available meeting time slots',
			...
			},
			{
				...
				name: 'createEvent',
				description: 'Book a meeting at the selected time slot',
				body: {
					type: 'object',
					...
					properties: {
						name: {
							type: 'string',
							description: 'Name of the user booking the meeting',
						},
						dateTime: {
							type: 'string',
							description: 'The selected time slot in ISO date format',
						},
					},
				},
			},
